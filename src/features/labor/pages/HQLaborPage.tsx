...
import { Save, UserPlus, Building2 } from 'lucide-react'
...
export default function HQLaborPage() {
  const now = new Date()
  ...
  const { employees, loading: loadingEmployees, createEmployee } = useEmployees(branchId, 'hq')
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">ทีมบริหาร HQ</h1>
      ...
      {employees.length > 0 && (
        <div className="card bg-base-100 card-enhanced">
          <div className="card-body">
            <h2 className="card-title text-lg">สรุปเงินเดือนทีมบริหาร HQ</h2>
      ...
      {employees.length === 0 ? (
        <div className="card bg-base-100 card-enhanced">
          <div className="card-body text-center py-12">
            <Building2 className="w-12 h-12 mx-auto text-base-content/30" />
            <p className="text-base-content/60 mt-4">
              ยังไม่มีพนักงานทีมบริหาร HQ ในสาขานี้
            </p>
